  ...
  return (
    <div>
      ...
      <form>
        ...
        <br />
        {change ? (
          <button  className="submit-input" onClick={handleclick}>Submit</button>
        ) : (
          ...
          {table.map((item, index) => {
            return (
              <tr key={index}>
                ...
                <td>{item.password}</td>
                <td>
                  <button className="delete-button" onClick={() => delItem(index)}>delItem</button>
                </td>
                <td>
                  <button className="update-button" onClick={() => Editfun(item)}>Edit</button>
                </td>
              </tr>
            );
          })}
